...
Upload a 4-column frame — **Woreda | Kebele | Village | HHs** — and this app performs **kebele-level PPS sampling** to select villages. Choose **Systematic** (default) or **Independent** PPS and configure **m** per kebele.
...
## Output
- **Sampled_Villages.csv** — selected villages with the **same 4 columns**.
...
## Branding
- Replace the placeholder images in `assets/` with your actual `wfp_logo.png` and `favicon.png`.
